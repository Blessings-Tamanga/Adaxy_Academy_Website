...
$status=1;
$sql="INSERT INTO  tblsubjectcombination(SCCode,SubjectCode,status) VALUES(:sccode,:subject,:status)";
...
<html lang="en">
    <head>
        ...
        <title>DAXY ACADAMY Admin Subject Combination< </title>
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Subject Combination Code</label>
                                                        <div class="col-sm-10">
 <select name="sccode" class="form-control" id="default" required="required">
<option value="">Select Subject Combination Code</option>
<?php $sql = "SELECT * from tblsccode";
$query = $dbh->prepare($sql);
$query->execute();
...
foreach($results as $result)
{   ?>
<option value="<?php echo htmlentities($result->SubjectCode); ?>"><?php echo htmlentities($result->SubjectName); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
